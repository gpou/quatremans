class Producte < ActiveRecord::Base
  attr_accessible :slug, :nom, :descripcio, :preu, :locale, :coleccio_id, :translations_attributes, :fotos_attributes, :disponible, :actiu, :tipus, :dificultat, :coordenades_coleccio, :dibuix, :svg, :svg_davant, :svg_darrera, :svg_estampat, :svg_estampat_davant, :svg_estampat_darrera, :position, :coleccio_path, :coleccio_mascara_path, :configparametres_attributes
